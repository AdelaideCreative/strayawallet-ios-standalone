...
class Sender {
    ...
    private func postProtocolPaymentIfNeeded() {
        ...
        request.setValue("application/strayacoin-payment", forHTTPHeaderField: "Content-Type")
        request.addValue("application/strayacoin-paymentack", forHTTPHeaderField: "Accept")
        ...
        URLSession.shared.dataTask(with: request as URLRequest) { data, response, error in
            ...
            if response.mimeType == "application/strayacoin-paymentack" && data.count <= 50000 {
